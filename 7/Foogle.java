...
public class Foogle
{
  ...
  //findPosition() method returns an integer
  //which represents the first position that contains the target value
  public static int findPosition( ArrayList al, int target )
  {
    for( int pos=0; pos<al.size(); pos++) { //iterates through the arrayList al
      if (al.get(pos).equals(target)) //checks each value to see if it equals target
        return pos; //if value at pos equals target, return pos
    }
    return -1; //else return -1
  }//end findPosition()


  // Initialize and return the arrayList with numItems, lo, and hi
  ...
  public static void main( String[] args )
  {
    ...
    System.out.println(findPosition(al000,3));
